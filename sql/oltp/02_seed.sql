-- Assignment sample data. NOTE: the original listing inserts `billing` BEFORE
-- `encounters`, which violates billing.encounter_id -> encounters. Reordered.
-- Parent-first order: specialties, departments, providers, patients, diagnoses, procedures, encounters, junctions, billing.
...
-- Only 7001 and 7002 are billed. 7003 and 7004 have NO billing row on purpose:
-- that is your INNER-vs-LEFT JOIN decision in Q4.
